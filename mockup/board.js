...
function board({ title, intro, columns }) {
  ...
  document.body.innerHTML = `
    <div class="board-bar">
      <h1>${title}</h1>
      <a href="shell.html">shell</a><a href="projects.html">projects</a><a href="plugins.html">plugins</a><a href="samples.html">samples</a><a href="collections.html">collections</a>
